// ==UserScript==
// @name www.amy.hi-ho.ne.jp/okuhara Accessibility Fixes
// @description    Improves the accessibility of www.amy.hi-ho.ne.jp/okuhara
// @author         James Teh, ajackpot
// @copyright 2019-2022 Mozilla Corporation, Derek Riemer
// @license Mozilla Public License version 2.0
// @version        2019.1
// @include http://www.amy.hi-ho.ne.jp/okuhara/*
// ==/UserScript==
...
const DYNAMIC_TWEAKS = [
	...
	{selector: 'td>img[src$="ajax/PieceL0.gif"]',
		tweak: e => {
	...
	{selector: 'td>img[src$="ajax/PieceL1.gif"]',
		tweak: e => {
			e.setAttribute('aria-roledescription', '버튼');
	...
	{selector: 'td>img[src$="ajax/PieceL2.gif"]',
		tweak: e => {
			e.setAttribute('aria-roledescription', '버튼');
	...
	{selector: 'td>img[src$="ajax/PieceF1.gif"]',
		tweak: [setLabel, '흑 뒤집힘']},
	{selector: 'td>img[src$="ajax/PieceF2.gif"]',
		tweak: [setLabel, '백 뒤집힘']},
];
