// ==UserScript==
// @name www.egaroucid.nyanyan.dev Accessibility Fixes
// @description    Improves the accessibility of www.egaroucid.nyanyan.dev
// @author         James Teh, ajackpot
// @copyright 2019-2022 Mozilla Corporation, Derek Riemer
// @license Mozilla Public License version 2.0
// @version        2019.1
// @include https://www.egaroucid.nyanyan.dev/*
// ==/UserScript==
...
const DYNAMIC_TWEAKS = [
	{selector: '.table_board',
		tweak: e => {
			document.addEventListener('keydown', (event) => {
				event = event || window.event;
				let keycode = event.keycode || event.which;
				if (keycode == 86 && event.altKey) {
					for (cell of e.querySelectorAll('.legal_stone_black')) cell.setAttribute('aria-label', cell.innerHTML);
					for (cell of e.querySelectorAll('.legal_stone_white')) cell.setAttribute('aria-label', cell.innerHTML);
				}
			}, false);
		},
	},
