// ==UserScript==
// @name hewgill.com/othello Accessibility Fixes
// @description    Improves the accessibility of hewgill.com/othello
// @author         ajackpot
// @copyright 2019-2022 Mozilla Corporation, Derek Riemer
// @license Mozilla Public License version 2.0
// @version        2019.1
// @include https://hewgill.com/othello/*
// ==/UserScript==
...
const DYNAMIC_TWEAKS = [
	{selector: 'td>img[id]',
		tweak: e => {
			let rowNumber = e.id[0].charCodeAt() - 64;
			let colNumber = String.fromCharCode(Number(e.id[1]) + 96);
