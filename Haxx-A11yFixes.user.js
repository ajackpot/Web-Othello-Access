// ==UserScript==
// @name www.haxx.se Accessibility Fixes
// @description    Improves the accessibility of www.haxx.se 
...
const DYNAMIC_TWEAKS = [
	{selector: 'select[name="SKILL"]',
		tweak: [setLabel, 'Choose your skill:']},
	{selector: 'input[name="LEGALMOVES"]',
		tweak: [setLabel, 'Show Legal Moves - Put an X on every square you can move to.']},
	{selector: 'input[name="FLIPPEDDISCS"]',
		tweak: [setLabel, 'Show Flipped Discs - Put an X on every disc that was flipped by the last move.']},
	{selector: 'input[src="images/blackstart.gif"]',
		tweak: [setLabel, 'Start with black']},
	{selector: 'input[src="images/whitestart.gif"]',
		tweak: [setLabel, 'Start with white']},
	{selector: 'table[cellpadding="1"]>tbody>tr>td>img[src^="images"]',
		tweak: e => {
			let p = e.parentNode;
			let p2 = p.parentNode;
	...
	{selector: 'table[cellpadding="1"]>tbody>tr>td>a>img[src^="images"]',
		tweak: e => {
	...
	{selector: 'img[src="images/green.gif"]',
		tweak: e => {
			e.setAttribute('aria-label', '빈칸');
		},
	},
	{selector: 'img[src="images/black.gif"]',
		tweak: e => {
			e.setAttribute('aria-label', '흑');
		},
	},
	{selector: 'img[src="images/white.gif"]',
		tweak: e => {
			e.setAttribute('aria-label', '백');
		},
	},
	{selector: 'img[src="images/newblack.gif"]',
		tweak: e => {
			e.setAttribute('aria-label', '흑 뒤집힘');
		},
	},
	{selector: 'img[src="images/newwhite.gif"]',
		tweak: e => {
			e.setAttribute('aria-label', '백 뒤집힘');
		},
	},
	{selector: 'img[src="images/legalmove.gif"]',
		tweak: e => {
