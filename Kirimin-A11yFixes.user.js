	// ==UserScript==
// @name kirimin.me Accessibility Fixes
// @description    Improves the accessibility of kirimin.me
// @author         ajackpot
// @copyright 2019-2022 Mozilla Corporation, Derek Riemer
// @license Mozilla Public License version 2.0
// @version        2019.1
// @include https://web.archive.org/web/*/https://kirimin.me/game/osero/*
// ==/UserScript==
...
const DYNAMIC_TWEAKS = [
	...
	{selector: 'td',
		tweak: e => {
			if (e.className.length < 3) return;
			let rowNumber = Number(e.className[0]) + 1;
			let colNumber = String.fromCharCode(Number(e.className[2]) + 97);
