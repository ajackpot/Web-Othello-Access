	// ==UserScript==
// @name lazymuttgames.com Accessibility Fixes
// @description    Improves the accessibility of lazymuttgames.com
// @author         ajackpot
// @copyright 2019-2022 Mozilla Corporation, Derek Riemer
// @license Mozilla Public License version 2.0
// @version        2019.1
// @include https://lazymuttgames.com/games/Othello/*
// ==/UserScript==
...
const DYNAMIC_TWEAKS = [
	...
	{selector: 'a[href^="javascript:Clicked"]',
		tweak: e => {
			let link = e.getAttribute('href');
			let y = Number(link.substr(19, 1)) + 1;
			let x = String.fromCharCode(Number(link.substr(21, 1)) + 97);
			e.setAttribute('aria-label', x + '/' + y);
		},
	},
	{selector: 'img[src$="Othello-0.gif"]',
		tweak: e => {
			e.setAttribute('aria-label', '빈칸');
			e.parentNode.setAttribute('data-axS-empty-cell', 'true');
		},
	},
	{selector: 'img[src$="Othello-1.gif"]',
		tweak: e => {
	...
	{selector: 'img[src$="Othello-2.gif"]',
		tweak: e => {
