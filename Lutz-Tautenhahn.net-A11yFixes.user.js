	// ==UserScript==
// @name www.lutanho.net Accessibility Fixes
// @description    Improves the accessibility of www.lutanho.net
// @author         ajackpot
// @copyright 2019-2022 Mozilla Corporation, Derek Riemer
// @license Mozilla Public License version 2.0
// @version        2019.1
// @include https://www.lutanho.net/play/reversi.html
// ==/UserScript==
...
const DYNAMIC_TWEAKS = [
	{selector: 'input[type="radio"]',
		tweak: e => {
			...
			e.setAttribute('aria-label', e.nextElementSibling.innerText);
		},
	},
	{selector: 'td>a[onmouseover][onmouseout]',
		tweak: e => {
			let p = e.parentNode;
			let p2 = p.parentNode;
	...
	{selector: 'img[src*="reversi0.gif"]',
		tweak: e => {
			e.setAttribute('aria-label', '빈칸');
			e.parentNode.parentNode.setAttribute('data-axS-empty-cell', 'true');
		},
	},
	{selector: 'img[src*="reversi1.gif"]',
		tweak: e => {
			e.setAttribute('aria-label', '흑');
			if (e.parentNode.parentNode.getAttribute('data-axS-empty-cell') == 'true') {
				e.parentNode.parentNode.removeAttribute('data-axS-empty-cell');
				announce('흑 ' + e.parentNode.getAttribute('aria-label') + '에 착수함', 'axS-announce-new-stone');
				e.parentNode.focus();
			}
		},
	},
	{selector: 'img[src*="reversi2.gif"]',
		tweak: e => {
