// ==UserScript==
// @name royhung.com/reversi Accessibility Fixes
// @description    Improves the accessibility of royhung.com/reversi
// @author         James Teh, ajackpot
// @copyright 2019-2022 Mozilla Corporation, Derek Riemer
// @license Mozilla Public License version 2.0
// @version        2019.1
// @include https://royhung.com/reversi
// ==/UserScript==
...
const DYNAMIC_TWEAKS = [
	...
	{selector: '#board>circle[style*="fill: black"]',
		tweak: e => {
			e.setAttribute('role', 'img');
			e.setAttribute('aria-roledescription', '버튼');
			let siblings = [].slice.call(e.parentNode.children);
	...
	{selector: '#board>circle[style*="fill: white"]',
		tweak: e => {
			e.setAttribute('role', 'img');
			e.setAttribute('aria-roledescription', '버튼');
			let siblings = [].slice.call(e.parentNode.children);
