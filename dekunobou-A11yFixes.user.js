// ==UserScript==
// @name dekunobou.jj1guj.net Accessibility Fixes
// @description    Improves the accessibility of dekunobou.jj1guj.net
// @author         ajackpot
// @copyright 2019-2022 Mozilla Corporation, Derek Riemer
// @license Mozilla Public License version 2.0
// @version        2019.1
// @include https://dekunobou.jj1guj.net/*
// ==/UserScript==
...
const DYNAMIC_TWEAKS = [
	{selector: 'td',
		tweak: e => {
			...
			if (e.childNodes.length == 0) e.removeAttribute('data-axS-played-cell');
		},
	},
	{selector: '.stone_white',
		tweak: e => {
			e.setAttribute('role', 'button');
			e.setAttribute('tabindex', '0');
			e.setAttribute('aria-label', '백');
			if (!e.parentNode.hasAttribute('data-axS-played-cell')) {
				e.parentNode.setAttribute('data-axS-played-cell', 'true');
				announce('백 ' + e.parentNode.getAttribute('aria-description') + '에 착수함', 'axS-announce-new-stone');
				e.focus();
			}
		},
	},
	{selector: '.stone_black',
		tweak: e => {
			e.setAttribute('role', 'button');
			e.setAttribute('tabindex', '0');
	...
	{selector: '#point_white',
		tweak: e => {
			e.setAttribute('aria-description', '백');
		},
	},
	{selector: '#point_black',
		tweak: e => {
			e.setAttribute('aria-description', '흑');
		},
	},
	{selector: '.can_put',
		tweak: e => {
