	// ==UserScript==
// @name www.hanshq.net Accessibility Fixes
// @description    Improves the accessibility of www.hanshq.net
// @author         ajackpot
// @copyright 2019-2022 Mozilla Corporation, Derek Riemer
// @license Mozilla Public License version 2.0
// @version        2019.1
// @include https://www.hanshq.net/files/othello/web/web_othello.html
// @include https://www.hanshq.net/files/othello/web/web_othello2.html
// ==/UserScript==
...
const DYNAMIC_TWEAKS = [
	{selector: 'table[border]>tr>td>div',
		tweak: e => {
			let p = e.parentNode;
			let p2 = p.parentNode;
			let colNumber = String.fromCharCode(Number([].slice.call(p2.children).indexOf(p)) + 96);
			let rowNumber = (Number([].slice.call(p2.parentNode.children).indexOf(p2)));
			e.setAttribute('aria-description', colNumber + rowNumber);
			e.setAttribute('role', 'img');
		},
	},
	{selector: 'td>div[style*="background: transparent"]',
		tweak: e => {
			e.setAttribute('aria-label', '빈칸');
			e.parentNode.setAttribute('data-axS-empty-cell', 'true');
		},
	},
	{selector: 'td>div[style*="background: black"]',
		tweak: e => {
	...
	{selector: 'td>div[style*="background: white"]',
		tweak: e => {
