// ==UserScript==
// @name ogeon.github.io Accessibility Fixes
// @description    Improves the accessibility of ogeon.github.io
// @author         James Teh, ajackpot
// @copyright 2019-2022 Mozilla Corporation, Derek Riemer
// @license Mozilla Public License version 2.0
// @version        2019.1
// @include https://ogeon.github.io/reversi/*
// ==/UserScript==
...
// applied.
const DYNAMIC_TWEAK_ATTRIBS = ['style', 'color', 'class'];

// Tweaks that must be applied whenever an element is added/changed.
const DYNAMIC_TWEAKS = [
	{selector: '.Game_board_1qUAL',
		tweak: e => {
	...
	{selector: '.Game_board_1qUAL>div[class=""]',
		tweak: e => {
			e.setAttribute('aria-label', '빈칸');
			e.setAttribute('data-axS-empty-cell', 'true');
		},
	},
	{selector: '.Game_board_1qUAL>div.Game_hint_1gQZ3',
		tweak: e => {
			e.setAttribute('aria-label', '착수 가능');
			e.setAttribute('data-axS-empty-cell', 'true');
		},
	},
	{selector: '.Game_board_1qUAL>div.Game_black_38RnS',
		tweak: e => {
	...
	{selector: '.Game_board_1qUAL>div.Game_white_3HhrI',
		tweak: e => {
