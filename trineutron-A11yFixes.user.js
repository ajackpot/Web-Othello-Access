// ==UserScript==
// @name trineutron.github.io Accessibility Fixes
// @description    Improves the accessibility of trineutron.github.io
// @author         James Teh, ajackpot
// @copyright 2019-2022 Mozilla Corporation, Derek Riemer
// @license Mozilla Public License version 2.0
// @version        2019.1
// @include https://trineutron.github.io/othello/*
// ==/UserScript==
...
const DYNAMIC_TWEAKS = [
	...
	{selector: '.black',
		tweak: e => {
			...
			let rowNumber = Math.floor(stoneNumber / 9);
			let colNumber = String.fromCharCode((stoneNumber % 9) + 96);
			e.setAttribute('aria-description', '흑 ' + colNumber + rowNumber);
		},
	},
	{selector: '.white',
		tweak: e => {
			...
			if (e.hasAttribute('data-axS-empty-cell')) {
				...
				announce('백 ' + colNumber + rowNumber + '에 착수함', 'axS-announce-new-stone');
			}
			e.setAttribute('aria-description', '백 ' + colNumber + rowNumber);
		},
	},
];
